...
def prediction_page():
    ...
    wa1 = st.radio('Is it a Wilderness Area 1 (0/1)', options=[1, 0])
    wa2 = st.radio('Is it a Wilderness Area 2 (0/1)', options=[1, 0])
    wa3 = st.radio('Is it a Wilderness Area 3 (0/1)', options=[1, 0])
    wa4 = st.radio('Is it a Wilderness Area 4 (0/1)', options=[1, 0])
